...
# =============================================================================
#
# Description: Installs the latest stable NVM from source
# Supported OS: Fedora, Ubuntu, Debian-based distributions
# Installation time: ~5-10 minutes depending on system performance
#
# What this script does:
# 1. Checks if NVM is already installed
# 2. Clones nvm stable branch from GitHub
# 4. Builds nvm with optimized settings
# 5. Installs system-wide to /usr/local/bin/nvm
# =============================================================================
